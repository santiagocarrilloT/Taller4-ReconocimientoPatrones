...
class limpiarParalelaTest extends AnyFunSuiteLike {
  ...
  test("Test Limpiar 1"){
    ...
    assert(np.limpiarParalela(expr,0,15) == Prod(Suma(Prod(Expo(Atomo('x'),Numero(2.0)),Numero(2.0)),Resta(Atomo('x'),Numero(1.0))),Suma(Expo(Atomo('x'),Numero(3.0)),Resta(Suma(Prod(Numero(4.0),Expo(Atomo('x'),Numero(2.0))),Prod(Numero(5.0),Atomo('x'))),Numero(6.0)))))
  }
  test("Test Limpiar 2"){
  ...
  test("Test Limpiar 3"){
    ...
    assert(np.limpiarParalela(expr,0,1) == Prod(Suma(Prod(Expo(Atomo('x'),Numero(3.0)),Numero(-2.0)),Suma(Expo(Atomo('x'),Numero(2.0)),Prod(Numero(3.0),Atomo('x')))),Suma(Prod(Expo(Atomo('x'),Numero(4.0)),Numero(4.0)),Suma(Prod(Numero(-5.0),Expo(Atomo('x'),Numero(2.0))),Suma(Prod(Numero(6.0),Atomo('x')),Numero(-7.0))))))
  }
  test("Test Limpiar 4"){
    val expr = Prod(
      Suma(
    ...
    assert(np.limpiarParalela(expr,0,1) == Prod(Suma(Prod(Numero(3.0),Expo(Atomo('x'),Numero(4.0))),Expo(Atomo('x'),Numero(2.0))),Div(Logaritmo(Suma(Expo(Atomo('x'),Numero(3.0)),Suma(Prod(Numero(2.0),Atomo('x')),Numero(1.0)))),Prod(Numero(6.0),Atomo('x')))))
  }
  ...
  test("Test Limpiar 5") {
    ...
    assert(np.limpiarParalela(expr,0,1) == Prod(Suma(Numero(2.0),Resta(Numero(1.0),Resta(Prod(Atomo('x'),Numero(3.0)),Numero(6.0)))),Resta(Expo(Atomo('x'),Numero(5.0)),Suma(Suma(Suma(Prod(Numero(5.0),Expo(Atomo('x'),Numero(4.0))),Prod(Numero(10.0),Expo(Atomo('x'),Numero(3.0)))),Expo(Atomo('x'),Numero(2.0))),Resta(Atomo('x'),Numero(1.0))))))
